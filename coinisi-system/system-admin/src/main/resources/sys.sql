...
CREATE TABLE `sys_config` (
  ...
  `value` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `set_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `set_by` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables', 'OFF', '2021-04-20 13:57:23', NULL);
INSERT INTO `sys_config` VALUES ('diagnostics.include_raw', 'OFF', '2021-04-20 13:57:23', NULL);
INSERT INTO `sys_config` VALUES ('ps_thread_trx_info.max_length', '65535', '2021-04-20 13:57:23', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.limit', '100', '2021-04-20 13:57:23', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.view', NULL, '2021-04-20 13:57:23', NULL);
INSERT INTO `sys_config` VALUES ('statement_truncate_len', '64', '2021-04-20 13:57:23', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='部门表';
...
INSERT INTO `sys_dept` VALUES (2, '测试部', 0, '0', 3, '李四', '18566956848', '45846655555@qq.com', 1, 0, '2021-01-26 13:53:46', '2021-01-26 13:53:58');
INSERT INTO `sys_dept` VALUES (7, '运维部', 1, '0,1', 1, '', '', '', 1, 0, '2021-02-18 18:02:38', '2021-02-18 18:02:38');
INSERT INTO `sys_dept` VALUES (8, '工控部', 1, '0,1', 1, '', '', '', 1, 0, '2021-02-18 18:03:05', '2021-02-18 18:03:05');
INSERT INTO `sys_dept` VALUES (9, '工控部', 1, '0,1', 1, '', '', '', 1, 0, '2021-02-18 18:03:05', '2021-02-18 18:03:05');
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dict_item` VALUES (1, '男', '你好', 'gender', 1, 1, 1, '性别男', '2019-05-05 13:07:52', '2019-07-02 14:23:05');
...
CREATE TABLE `sys_file` (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件原名',
  `current_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件现名',
  `url` varchar(600) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件存储路径',
  `size` decimal(10,2) DEFAULT NULL COMMENT '文件大小',
  `is_delete` tinyint DEFAULT NULL COMMENT '1已删除2未删除',
  `remark` varchar(2555) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统文件';

-- ----------------------------
-- Records of sys_file
-- ----------------------------
BEGIN;
INSERT INTO `sys_file` VALUES (1414222377176403968, 'JPEG', '1625132736369', '4737f6a1-04e5-4f16-b7ab-7873f4943aec.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\73075196-1369-4b4c-a944-41f223e5b857.jpgafe3d60d-ac5c-4d1a-82db-727972f8b214.jpg58dfe3b4-284e-47f3-b64e-5d6ca20d19c4.jpg7b550b80-4443-4bed-b8dc-cdd685ac6041.jpg4737f6a1-04e5-4f16-b7ab-7873f4943aec.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414223524201107456, 'JPEG', '1625132736369', '62a8a174-fe8c-44f4-8e06-955fef0730a9.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\62a8a174-fe8c-44f4-8e06-955fef0730a9.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414223882151399424, 'JPEG', '1625132736369', 'fd4816c3-6166-4e17-9df0-4c74e8c1cbcc.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\62a8a174-fe8c-44f4-8e06-955fef0730a9.jpgfd4816c3-6166-4e17-9df0-4c74e8c1cbcc.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414223943803473920, 'JPEG', '1625132736369', '449510d5-c2b3-4300-8aa7-74ff616b940f.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\62a8a174-fe8c-44f4-8e06-955fef0730a9.jpgfd4816c3-6166-4e17-9df0-4c74e8c1cbcc.jpg449510d5-c2b3-4300-8aa7-74ff616b940f.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224252248395776, 'JPEG', '1625132736369', '90de70d0-ef38-47da-947d-9dd29d607e29.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\90de70d0-ef38-47da-947d-9dd29d607e29.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224257373835264, 'JPEG', '1625132736369', 'a25a7c1a-2ef1-4ca5-bd74-7d8b7f65a45d.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\90de70d0-ef38-47da-947d-9dd29d607e29.jpga25a7c1a-2ef1-4ca5-bd74-7d8b7f65a45d.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224261672996864, 'JPEG', '1625132736369', 'a3346124-b657-4824-99c2-0a9c49e94516.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\90de70d0-ef38-47da-947d-9dd29d607e29.jpga25a7c1a-2ef1-4ca5-bd74-7d8b7f65a45d.jpga3346124-b657-4824-99c2-0a9c49e94516.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224265275904000, 'JPEG', '1625132736369', '7606ee73-9bb5-4b28-aa72-9a14d353a4ef.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\90de70d0-ef38-47da-947d-9dd29d607e29.jpga25a7c1a-2ef1-4ca5-bd74-7d8b7f65a45d.jpga3346124-b657-4824-99c2-0a9c49e94516.jpg7606ee73-9bb5-4b28-aa72-9a14d353a4ef.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224526262276096, 'JPEG', '1625132736369', '498b7f0d-5999-4dbb-9378-64317aef05a0.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\498b7f0d-5999-4dbb-9378-64317aef05a0.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414224729082040320, 'JPEG', '1625132736369', '2aa97567-0587-4d60-958b-ddac71d92d73.jpg', 'C:\\\\Users\\\\mac\\\\Desktop\\\\498b7f0d-5999-4dbb-9378-64317aef05a0.jpg2aa97567-0587-4d60-958b-ddac71d92d73.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414226047989321728, 'JPEG', '1625132736369', 'bec08fc9-746c-45c0-bda4-51cc3b55ef79.jpg', 'C:\\Users\\mac\\Desktop\\bec08fc9-746c-45c0-bda4-51cc3b55ef79.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414226058974203904, 'JPEG', '1625132736369', 'a654edd7-e951-4a39-9756-bf009fd6c071.jpg', 'C:\\Users\\mac\\Desktop\\bec08fc9-746c-45c0-bda4-51cc3b55ef79.jpga654edd7-e951-4a39-9756-bf009fd6c071.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414226064640708608, 'JPEG', '1625132736369', 'c8915176-c3d9-4248-a6be-2580cddd36da.jpg', 'C:\\Users\\mac\\Desktop\\bec08fc9-746c-45c0-bda4-51cc3b55ef79.jpga654edd7-e951-4a39-9756-bf009fd6c071.jpgc8915176-c3d9-4248-a6be-2580cddd36da.jpg', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414227919663927296, 'JPEG', '1625132736369', 'c8041547-4a4b-479b-94bb-5d84fb0d11c8.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414227997271134208, 'JPEG', '1625132736369', '8dcc4dd3-20b3-4018-a671-c55638e2987c.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228004967682048, 'JPEG', '1625132736369', 'da443119-9d69-4017-a19d-8fcb17ef9ccf.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228082973347840, 'JPEG', '1625132736369', '247d4add-e6ae-464d-ac05-bcf2e2bcd029.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228083078205440, 'JPEG', '1625132751745', 'b5adc1bb-42a5-4b8a-8508-27e1eaf954a6.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228105022803968, 'JPEG', '1625132736369', '52338d6d-47a8-4e54-bb65-931b1b017bf5.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228105127661568, 'JPEG', '1625132751745', '005186a5-b6e3-4edc-8c43-c33812363928.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228108390830080, 'JPEG', '1625132736369', 'bbc41661-e27a-421d-af0c-273b3bc3c3ff.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228108491493376, 'JPEG', '1625132751745', '8248f3bf-a5d7-4e3c-8e51-4ceeb492e637.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228541809233920, 'JPEG', '1625132736369', '6d4d38c8-1a4c-4572-914c-77e2aa2e1f76.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414228650974384128, 'JPEG', '1625132751745', 'b4f1dc9b-8472-4ea2-b959-a7fc71e3559c.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414229061835821056, 'JPEG', '1625132736369', 'e629b882-d3a0-474a-80dd-9ece2c447e29.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414229091531493376, 'JPEG', '1625132751745', '7074d2d8-ef6c-485f-993f-c122108aa386.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414233885935538176, 'JPEG', '1625132736369', '3f9d3483-882c-4950-8009-0ee69b99b6c2.jpg', 'C:\\Users\\mac\\Desktop\\', 2463.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1414233902863749120, 'JPEG', '1625132751745', '2bc35430-3ec4-41b0-8f67-5095841da61e.jpg', 'C:\\Users\\mac\\Desktop\\', 2528.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420742935166717952, 'PNG', '截屏2021-07-29 下午4', '5407255f-8c48-49ee-b8bb-82df1133d1ba.11', '/Users/xyqws/IdeaProjects/coinisi/images', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420743798912323584, 'PNG', '截屏2021-07-29 下午4', '3b1900ee-0524-40be-bdf7-6eb461280fab.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744312634871808, 'PNG', '截屏2021-07-29 下午4', '5594c377-2d19-4851-89eb-c937eb5f2bb1.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744337846833152, 'PNG', '截屏2021-07-29 下午4', '0b7486c9-e0dc-4469-8652-3c8176eaa828.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744341193887744, 'PNG', '截屏2021-07-29 下午4', '62b1c798-1356-4857-9613-7e40e7802519.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744344092151808, 'PNG', '截屏2021-07-29 下午4', '92b31689-4146-4f21-bc05-6a1a73a06dc0.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744351671259136, 'PNG', '截屏2021-07-29 下午4', '6a003c7a-8e8d-4858-be82-44b8c42b9697.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420744354607271936, 'PNG', '截屏2021-07-29 下午4', 'b6eb7cd8-898f-4a9a-a94b-2f74da88832e.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420745123691630592, 'PNG', '截屏2021-07-29 下午4', 'e9feb74a-dbe6-48b6-92ed-0c881a6847cc.11', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420745775553581056, 'PNG', '截屏2021-07-29 下午4', '30902b12-7b22-4a29-85ff-6092b5da9c30.png', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420746127396966400, 'PNG', '截屏2021-07-29 下午4', 'd4a1c556-9f54-4a8b-a2d6-279d000d2f8d.png', '/Users/xyqws/IdeaProjects/coinisi/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420936579052081152, 'PNG', '截屏2021-07-29 下午4', '620f2adb-691f-4dea-8adc-756e059bd3e8.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1420937475370651648, 'PNG', '截屏2021-07-29 下午4', '70d26dce-1dd4-461e-b453-32ed7301604a.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 219.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421051119047675904, 'JPEG', 'WechatIMG149', 'e3b49bc4-87b1-4914-a80c-0ac8ab269e1f.jpeg', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 44.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421097613146591232, 'JPEG', 'WechatIMG149', '55a38cf1-1ffc-4d5d-bdaa-2fa75fc04c8d.jpeg', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 44.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421099004917321728, 'JPEG', 'WechatIMG149', '4c3cd4a0-ad7d-45b4-8296-36e404313b8b.jpeg', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 44.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421102322385293312, 'PNG', '2-stock-added-to-order-list', '9341a6bf-5a09-4093-b01c-5112b5678d79.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 17.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421106249885421568, 'PNG', '2-stock-added-to-order-list', 'd567257d-2e40-4ead-8313-bb8c1ae2cd7d.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 17.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421106466982596608, 'PNG', '3-purchase-suggestion', 'c32ce083-0cfb-4c50-8bdd-c09ec3c6cf4c.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 6.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421106982877794304, 'PNG', '2-stock-added-to-order-list', '5ea29f66-9f79-45d2-8f33-ac2a937d0028.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 17.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421107072359075840, 'PNG', '1-PetStore-Start-Screen', '437531d4-0aed-446b-aaef-14fc13aa55a8.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 15.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421107091568988160, 'PNG', '2-stock-added-to-order-list', '8da0b3f1-5b83-4ec1-a9b1-bba1f83d57a4.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 17.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421108300447092736, 'PNG', '2-stock-added-to-order-list', 'f8293991-e50e-4657-877a-13ab4c6893fe.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 17.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421109029798809600, 'PNG', '1-PetStore-Start-Screen', 'f6c1da32-9047-4711-97f9-8421f7390fd8.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 15.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421112890865356800, 'XML', 'setting-filling', '5b794313-d93a-45ca-9a4d-a74901b40d1e.svg', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 1.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421113263835451392, 'XML', 'setting-filling (1)', '3ab58bb1-5826-41fb-8572-ec706cad588c.svg', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 1.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421113590529789952, 'PNG', 'setting', '53a26172-8658-4cfb-b3d0-2bc03bb964ed.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 0.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421280888406282240, 'PNG', '设 置', '657b6207-b791-44f2-8dd3-dcae0c89f366.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 0.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421346425391943680, 'PNG', '用户 头像', 'e93ad153-f2dc-4881-af14-2545570a49ae.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 0.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421346873532354560, 'PNG', '设 置', 'e0162c71-3502-4be0-96f4-71018331937c.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 0.00, 2, NULL);
INSERT INTO `sys_file` VALUES (1421347216274100224, 'PNG', '用户', '169d5e66-b868-4d20-8631-a8afd984299c.png', '/Users/xyqws/IdeaProjects/coinisi/coinisi-system/system-admin/src/main/resources/static/images/', 0.00, 2, NULL);
COMMIT;
...
CREATE TABLE `sys_log` (
  ...
  `ip` varchar(255) DEFAULT NULL COMMENT '登录地址',
  `station` varchar(255) DEFAULT NULL COMMENT '登录地址',
  `system` varchar(255) DEFAULT NULL COMMENT '操作系统',
  `browser` varchar(255) DEFAULT NULL COMMENT '浏览器',
  `login_status` varchar(255) DEFAULT NULL COMMENT '状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建人',
  `create_user` bigint DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_log` VALUES (1, '1', '10', '1', '1', '1', '2', '2021-08-02 20:38:11', 1, '2021-08-02 20:38:16', NULL, 0, 0);
COMMIT;
...
CREATE TABLE `sys_menu` (
  ...
  `icon` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '菜单图标',
  `sort` int DEFAULT '0' COMMENT '排序',
  `visible` tinyint(1) DEFAULT '1' COMMENT '状态：0-禁用 1-开启',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1421782740466012161 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单管理';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, '/admin', 'Layout', '', 'http://127.0.0.1:8015/coinisi-system/static/images/657b6207-b791-44f2-8dd3-dcae0c89f366.png', 2, 1, '2020-09-23 09:12:21', '2021-02-25 17:49:49');
INSERT INTO `sys_menu` VALUES (2, '用户管理', 1, 'user', 'admin/user/index', '', 'http://127.0.0.1:8015/coinisi-system/static/images/169d5e66-b868-4d20-8631-a8afd984299c.png', 1, 1, NULL, '2021-02-28 17:33:14');
INSERT INTO `sys_menu` VALUES (4, '菜单管理', 1, 'menu', 'manager/menu', NULL, 'tree-table', 8, 1, '2020-09-23 09:12:21', '2021-02-02 12:50:30');
...
INSERT INTO `sys_menu` VALUES (1420015448979804160, '岗位管理', 1, '/admin/post', '/admin/post', '', '', 0, 1, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_permission` (
  ...
  `type` tinyint DEFAULT NULL COMMENT '权限类型 1-路由权限 2-按钮权限',
  `module_id` bigint DEFAULT NULL COMMENT '菜单模块ID\r\n',
  `gmt_create` datetime DEFAULT NULL,
  `gmt_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id` (`id`,`name`) USING BTREE,
  KEY `id_2` (`id`,`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限表';

-- ----------------------------
-- Records of sys_permission
-- ----------------------------
BEGIN;
INSERT INTO `sys_permission` VALUES (9, '营销管理', '/sys-user/queryUser', '*', 1, 9, '2020-10-24 15:29:01', '2021-02-05 19:59:09');
INSERT INTO `sys_permission` VALUES (12, '订单管理', '/sys-user', '*', 1, 13, '2020-10-31 10:40:35', '2021-02-05 19:59:17');
INSERT INTO `sys_permission` VALUES (13, '会员管理', '/sys-role/delete', '*', 1, 15, '2020-10-31 10:41:08', '2021-02-05 19:59:23');
INSERT INTO `sys_permission` VALUES (14, '商品管理', '/sys-role/selectRole', '*', 1, 11, '2020-10-31 10:41:37', '2021-02-05 19:59:01');
INSERT INTO `sys_permission` VALUES (18, '查询用户', '/sys-post/queryPost', 'GET', 1, 2, '2021-02-02 14:16:07', '2021-02-10 10:19:28');
INSERT INTO `sys_permission` VALUES (19, '新增', '/sys-dict', NULL, 2, 2, '2021-02-02 14:16:46', '2021-02-22 17:03:21');
INSERT INTO `sys_permission` VALUES (21, '修改', '/sys-user/delete', NULL, 2, 2, '2021-02-02 14:19:45', '2021-02-03 00:20:32');
INSERT INTO `sys_permission` VALUES (22, '删除', '/sys-dept/update', NULL, 2, 2, '2021-02-02 14:20:12', '2021-02-28 17:22:52');
INSERT INTO `sys_permission` VALUES (23, '查询', '/sys-dept/add', NULL, 2, 2, '2021-02-02 14:20:42', '2021-02-03 00:20:21');
INSERT INTO `sys_permission` VALUES (26, '重置密码', '/sys-role-menu/queryRoleMenu', NULL, 2, 2, '2021-02-05 14:31:53', '2021-02-05 14:33:27');
INSERT INTO `sys_permission` VALUES (30, '新增用户', '/sys-menu/update', 'POST', 1, 2, '2021-02-10 10:20:08', '2021-02-10 10:20:08');
INSERT INTO `sys_permission` VALUES (31, '修改用户', '/sys-role', 'PUT', 1, 2, '2021-02-10 10:20:32', '2021-02-10 10:20:32');
INSERT INTO `sys_permission` VALUES (32, '删除用户', '/sys-dept/getTree', 'DELETE', 1, 2, '2021-02-10 10:20:47', '2021-02-10 10:20:47');
INSERT INTO `sys_permission` VALUES (34, '菜单所有', '/sys-user-role/updateUserRole', '*', 1, 4, '2021-02-10 11:00:26', '2021-02-10 11:00:26');
INSERT INTO `sys_permission` VALUES (35, '部门所有', '/sys-user-role/**', '*', 1, 6, '2021-02-10 11:02:45', '2021-02-10 11:02:45');
INSERT INTO `sys_permission` VALUES (36, '角色所有', '/sys-post/delete', '*', 1, 23, '2021-02-10 11:03:05', '2021-02-10 11:03:05');
INSERT INTO `sys_permission` VALUES (37, '字典所有', '/sys-post/update', '*', 1, 5, '2021-02-10 11:03:49', '2021-02-10 11:03:49');
INSERT INTO `sys_permission` VALUES (38, '客户端所有', '/sys-dept/tree', '*', 1, 8, '2021-02-10 11:05:34', '2021-02-10 11:05:34');
INSERT INTO `sys_permission` VALUES (39, '权限所有', '/sys-role/save', '*', 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (42, '字典项所有', '/sys-role/update', '*', 1, NULL, '2021-02-14 10:48:17', '2021-02-15 16:13:02');
INSERT INTO `sys_permission` VALUES (44, '新增', '/sys-menu', NULL, 2, 5, '2021-02-23 13:24:31', '2021-02-23 13:24:31');
INSERT INTO `sys_permission` VALUES (45, '文件上传', '/sys-user/getUser', '*', 1, 34, '2021-02-27 23:35:27', '2021-02-27 23:35:27');
INSERT INTO `sys_permission` VALUES (46, '90', '/sys-menu/getSelectTreeMenu', NULL, 2, 4, '2021-03-01 10:38:09', '2021-03-01 10:38:09');
INSERT INTO `sys_permission` VALUES (47, '字典', '/sys-dict-item/queryDictItem', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (48, NULL, '/sys-dict-item/save', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (49, NULL, '/sys-dict-item/update', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (50, NULL, '/sys-dict-item/delete', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (51, NULL, '/sys-post/save', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (52, 'dad', '/common/file', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (53, 'da ', '/sys-dept/delete', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (54, '日志', '/sys-log/removes', NULL, 1, 4, NULL, NULL);
INSERT INTO `sys_permission` VALUES (55, '日志查询', '/sys-log/list', NULL, 1, 4, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_post` (
  ...
  PRIMARY KEY (`post_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1421777723523850243 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='岗位信息表';

-- ----------------------------
-- Records of sys_post
-- ----------------------------
BEGIN;
INSERT INTO `sys_post` VALUES (1420015671559921666, 'CEO', 'IT经理', 3, '1', '', NULL, '', NULL, '测试');
COMMIT;
...
CREATE TABLE `sys_role` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '角色名称',
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  `identification` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限标识',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1418842012974714881 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色表';

-- ----------------------------
-- Records of sys_role
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '超级管理员', 1, 1, 0, '2021-07-27 12:00:10', '2020-09-11 17:04:23', 'admin');
INSERT INTO `sys_role` VALUES (2, '系统管理员', 2, 1, 0, '2018-12-23 16:00:00', '2020-09-22 17:01:44', 'system');
INSERT INTO `sys_role` VALUES (3, '普通用户', 3, 1, 0, '2019-05-05 16:00:00', '2020-09-22 17:09:54', 'common');
...
INSERT INTO `sys_role` VALUES (1414787822925254656, '精神小孩', 10, 1, 0, '2021-07-13 05:39:29', NULL, 'adminss');
INSERT INTO `sys_role` VALUES (1415133160190119936, '良好', 45, 1, 0, '2021-07-14 02:22:30', NULL, 'admin');
INSERT INTO `sys_role` VALUES (1418842012974714880, '阿是多少', 2, 1, 0, '2021-07-24 07:54:31', NULL, '大');
COMMIT;
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1421782740469194754 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色和菜单关联表';
...
INSERT INTO `sys_role_menu` VALUES (6, 1, 23);
INSERT INTO `sys_role_menu` VALUES (7, 1414787822925254656, 3);
INSERT INTO `sys_role_menu` VALUES (8, 1414787822925254656, 5);
INSERT INTO `sys_role_menu` VALUES (9, 1415133160190119936, 1);
INSERT INTO `sys_role_menu` VALUES (10, 1415133160190119936, 23);
INSERT INTO `sys_role_menu` VALUES (11, 1415133160190119936, 6);
INSERT INTO `sys_role_menu` VALUES (12, 1415133160190119936, 5);
INSERT INTO `sys_role_menu` VALUES (13, 1415133160190119936, 4);
INSERT INTO `sys_role_menu` VALUES (14, 1418842012974714880, 23);
INSERT INTO `sys_role_menu` VALUES (15, 1, 1418909915770130432);
INSERT INTO `sys_role_menu` VALUES (16, 1, 1418909640200163328);
INSERT INTO `sys_role_menu` VALUES (17, 1, 1420002829845794816);
INSERT INTO `sys_role_menu` VALUES (18, 1414787822925254656, 1420002829845794816);
INSERT INTO `sys_role_menu` VALUES (19, 3, 1420002829845794816);
INSERT INTO `sys_role_menu` VALUES (20, 15, 1420002829845794816);
INSERT INTO `sys_role_menu` VALUES (21, 1, 1420003929944625152);
INSERT INTO `sys_role_menu` VALUES (22, 1414787822925254656, 1420003929944625152);
INSERT INTO `sys_role_menu` VALUES (23, 3, 1420003929944625152);
INSERT INTO `sys_role_menu` VALUES (24, 15, 1420003929944625152);
INSERT INTO `sys_role_menu` VALUES (25, 1, 1420004276566102016);
INSERT INTO `sys_role_menu` VALUES (26, 1414787822925254656, 1420004276566102016);
INSERT INTO `sys_role_menu` VALUES (27, 3, 1420004276566102016);
INSERT INTO `sys_role_menu` VALUES (28, 15, 1420004276566102016);
INSERT INTO `sys_role_menu` VALUES (29, 1, 1420015448979804160);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色权限表';

-- ----------------------------
-- Records of sys_role_permission
-- ----------------------------
BEGIN;
INSERT INTO `sys_role_permission` VALUES (1, 14, 1);
INSERT INTO `sys_role_permission` VALUES (1, 13, 2);
INSERT INTO `sys_role_permission` VALUES (2, 12, 3);
INSERT INTO `sys_role_permission` VALUES (1, 9, 4);
INSERT INTO `sys_role_permission` VALUES (2, 1, 5);
INSERT INTO `sys_role_permission` VALUES (1, 22, 6);
INSERT INTO `sys_role_permission` VALUES (1, 23, 7);
INSERT INTO `sys_role_permission` VALUES (1, 19, 8);
INSERT INTO `sys_role_permission` VALUES (1, 21, 9);
INSERT INTO `sys_role_permission` VALUES (1, 26, 10);
INSERT INTO `sys_role_permission` VALUES (1, 18, 11);
INSERT INTO `sys_role_permission` VALUES (1, 35, 12);
INSERT INTO `sys_role_permission` VALUES (1, 36, 13);
INSERT INTO `sys_role_permission` VALUES (1, 34, 14);
INSERT INTO `sys_role_permission` VALUES (1, 37, 15);
INSERT INTO `sys_role_permission` VALUES (1, 38, 16);
INSERT INTO `sys_role_permission` VALUES (1, 39, 17);
INSERT INTO `sys_role_permission` VALUES (1, 31, 18);
INSERT INTO `sys_role_permission` VALUES (1, 30, 19);
INSERT INTO `sys_role_permission` VALUES (1, 32, 20);
INSERT INTO `sys_role_permission` VALUES (2, 9, 21);
INSERT INTO `sys_role_permission` VALUES (2, 18, 22);
INSERT INTO `sys_role_permission` VALUES (2, 39, 23);
INSERT INTO `sys_role_permission` VALUES (2, 37, 24);
INSERT INTO `sys_role_permission` VALUES (2, 38, 25);
INSERT INTO `sys_role_permission` VALUES (2, 26, 26);
INSERT INTO `sys_role_permission` VALUES (2, 19, 27);
INSERT INTO `sys_role_permission` VALUES (2, 22, 28);
INSERT INTO `sys_role_permission` VALUES (2, 23, 29);
INSERT INTO `sys_role_permission` VALUES (2, 21, 30);
INSERT INTO `sys_role_permission` VALUES (1, 41, 31);
INSERT INTO `sys_role_permission` VALUES (1, 12, 32);
INSERT INTO `sys_role_permission` VALUES (1, 43, 33);
INSERT INTO `sys_role_permission` VALUES (1, 42, 34);
INSERT INTO `sys_role_permission` VALUES (2, 34, 35);
INSERT INTO `sys_role_permission` VALUES (2, 42, 36);
INSERT INTO `sys_role_permission` VALUES (2, 30, 37);
INSERT INTO `sys_role_permission` VALUES (2, 31, 38);
INSERT INTO `sys_role_permission` VALUES (15, 32, 39);
INSERT INTO `sys_role_permission` VALUES (15, 31, 40);
INSERT INTO `sys_role_permission` VALUES (15, 30, 41);
INSERT INTO `sys_role_permission` VALUES (15, 18, 42);
INSERT INTO `sys_role_permission` VALUES (15, 26, 43);
INSERT INTO `sys_role_permission` VALUES (15, 42, 44);
INSERT INTO `sys_role_permission` VALUES (1, 44, 45);
INSERT INTO `sys_role_permission` VALUES (1, 12, 46);
INSERT INTO `sys_role_permission` VALUES (18, 37, 47);
INSERT INTO `sys_role_permission` VALUES (2, 35, 48);
INSERT INTO `sys_role_permission` VALUES (3, 32, 49);
INSERT INTO `sys_role_permission` VALUES (3, 31, 50);
INSERT INTO `sys_role_permission` VALUES (3, 19, 51);
INSERT INTO `sys_role_permission` VALUES (2, 45, 52);
INSERT INTO `sys_role_permission` VALUES (1, 45, 53);
INSERT INTO `sys_role_permission` VALUES (1, 46, 54);
INSERT INTO `sys_role_permission` VALUES (1, 47, 55);
INSERT INTO `sys_role_permission` VALUES (1, 48, 56);
INSERT INTO `sys_role_permission` VALUES (1, 49, 57);
INSERT INTO `sys_role_permission` VALUES (1, 50, 58);
INSERT INTO `sys_role_permission` VALUES (1, 51, 59);
INSERT INTO `sys_role_permission` VALUES (1, 36, 60);
INSERT INTO `sys_role_permission` VALUES (1, 37, 61);
INSERT INTO `sys_role_permission` VALUES (1, 38, 62);
INSERT INTO `sys_role_permission` VALUES (1, 18, 63);
INSERT INTO `sys_role_permission` VALUES (1, 52, 64);
INSERT INTO `sys_role_permission` VALUES (1, 53, 65);
INSERT INTO `sys_role_permission` VALUES (1, 54, 66);
INSERT INTO `sys_role_permission` VALUES (1, 55, 67);
COMMIT;
...
CREATE TABLE `sys_role_scope` (
  `id` bigint NOT NULL,
  `scope_category` int DEFAULT NULL COMMENT '权限类型 1数据权限 2接口权限',
...
CREATE TABLE `sys_scope_data` (
  `id` bigint NOT NULL COMMENT '主键1',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户信息表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'root', '超级管理员', 1, '$2a$10$uspnfsOSE345n2ZVNwO/8.pEkvfjkm6fieZfEjZ0F9w1DkiPeh5ya', 1, 0, 'https://gitee.com/haoxr/image/raw/master/default/807b1042ed4c674d97bcf1f2976234d.jpg', '17621590365', 1, '1490493387@qq.com', '2021-02-09 20:27:30', '2021-02-28 17:44:44');
...
CREATE TABLE `sys_user_role` (
  ...
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1421447107825623043 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户和角色关联表';
...
INSERT INTO `sys_user_role` VALUES (9, 2, 4);
INSERT INTO `sys_user_role` VALUES (6, 3, 7);
INSERT INTO `sys_user_role` VALUES (8, 3, 8);
INSERT INTO `sys_user_role` VALUES (5, 15, 10);
INSERT INTO `sys_user_role` VALUES (7, 15, 11);
INSERT INTO `sys_user_role` VALUES (5, 1414787822925254656, 13);
INSERT INTO `sys_user_role` VALUES (2, 2, 1421446939260739585);
INSERT INTO `sys_user_role` VALUES (2, 3, 1421446939264933889);
INSERT INTO `sys_user_role` VALUES (2, 14, 1421446939273322498);
INSERT INTO `sys_user_role` VALUES (1, 3, 1421447107783680001);
INSERT INTO `sys_user_role` VALUES (1, 15, 1421447107792068609);
INSERT INTO `sys_user_role` VALUES (1, 14, 1421447107796262914);
INSERT INTO `sys_user_role` VALUES (1, 1414787822925254656, 1421447107800457218);
INSERT INTO `sys_user_role` VALUES (1, 2, 1421447107808845826);
INSERT INTO `sys_user_role` VALUES (1, 1415133160190119936, 1421447107813040129);
INSERT INTO `sys_user_role` VALUES (1, 1, 1421447107821428737);
INSERT INTO `sys_user_role` VALUES (1, 1418842012974714880, 1421447107825623042);
COMMIT;
